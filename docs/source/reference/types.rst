...
.. note::
    ...
    This page is about types specific to CUDA kernels. Many other types are also
...
are usable in kernels. There are two important distinctions from vector types in CUDA C++:

First, the recommended names for vector types in Numba CUDA MLIR is formatted
as ``<base_type>x<N>``, where ``base_type`` is the base type of the vector, and
``N`` is the number of elements in the vector. Examples include ``int64x3``,
``uint16x4``, ``float32x4``, etc. For new Numba CUDA kernels, this is the
recommended way to instantiate vector types.

For convenience, users adapting existing kernels from CUDA C++ to Python may
use aliases consistent with the C++ namings. For example, ``float3`` aliases
``float32x3``, ``long3`` aliases ``int32x3`` or ``int64x3`` (depending on the
platform), etc.

Second, unlike CUDA C++ where factory functions are used, vector types are
constructed directly with their constructor. For example, to construct a
``float32x3``:
...
.. note::
    ...
    Bfloat16 is only supported on devices with Compute Capability 8.0 or above.
...
.. function:: numba_cuda_mlir.cuda.types.bfloat16(b)
...
.. function:: numba_cuda_mlir.cuda.bf16.hsin(b)
...
.. function:: numba_cuda_mlir.cuda.bf16.htanh(b)

    Calculates bfloat16 hyperbolic tangent function: ``tanh(b)`` in round-to-nearest-even mode.

.. function:: numba_cuda_mlir.cuda.bf16.htanh_approx(b)
...
.. function:: numba_cuda_mlir.cuda.bf16.hexp(b)

    Calculates bfloat16 natural exponential function of input ``b`` in
    round-to-nearest-even mode.

.. function:: numba_cuda_mlir.cuda.bf16.hexp2(b)

    Calculates bfloat16 binary exponential function of input ``b`` in
    round-to-nearest-even mode.

.. function:: numba_cuda_mlir.cuda.bf16.hexp10(b)
...
.. function:: numba_cuda_mlir.cuda.bf16.hmin(a, b)

    Returns ``min(a, b)`` with the following behavior:
    if either input is NaN, the other input is returned; if both are NaN,
    the canonical NaN is returned. If both inputs are zero, ``+0.0 > -0.0``.

.. function:: numba_cuda_mlir.cuda.bf16.hmax_nan(a, b)

    Returns ``max(a, b)`` where NaNs pass through: if either input is NaN,
    the canonical NaN is returned.

.. function:: numba_cuda_mlir.cuda.bf16.hmin_nan(a, b)
...
.. function:: numba_cuda_mlir.cuda.bf16.hisnan(a)

    Returns ``True`` if ``a`` is a NaN, ``False`` otherwise.

.. function:: numba_cuda_mlir.cuda.bf16.hisinf(a)
...
.. function:: numba_cuda_mlir.cuda.bf16.float32_to_bfloat16(x)

    Convert a ``float32`` to ``bfloat16`` (default rounding is round-to-nearest-even).

.. function:: numba_cuda_mlir.cuda.bf16.float64_to_bfloat16(x)

    Convert a ``float64`` to ``bfloat16`` (default rounding is round-to-nearest-even).

.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_float32(x)

    Convert a ``bfloat16`` to ``float32``.

.. function:: numba_cuda_mlir.cuda.bf16.float32_to_bfloat16_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.float32_to_bfloat16_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.float32_to_bfloat16_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.float32_to_bfloat16_ru(x)
...
.. function:: numba_cuda_mlir.cuda.bf16.int16_to_bfloat16_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.int16_to_bfloat16_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.int16_to_bfloat16_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.int16_to_bfloat16_ru(x)

    Convert an ``int16`` to ``bfloat16`` with the selected rounding mode.

.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int16_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int16_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int16_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int16_ru(x)
...
.. function:: numba_cuda_mlir.cuda.bf16.uint16_to_bfloat16_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.uint16_to_bfloat16_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.uint16_to_bfloat16_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.uint16_to_bfloat16_ru(x)

    Convert a ``uint16`` to ``bfloat16`` with the selected rounding mode.

.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint16_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint16_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint16_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint16_ru(x)
...
.. function:: numba_cuda_mlir.cuda.bf16.int32_to_bfloat16_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.int32_to_bfloat16_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.int32_to_bfloat16_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.int32_to_bfloat16_ru(x)

    Convert an ``int32`` to ``bfloat16`` with the selected rounding mode.

.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int32_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int32_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int32_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int32_ru(x)
...
.. function:: numba_cuda_mlir.cuda.bf16.uint32_to_bfloat16_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.uint32_to_bfloat16_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.uint32_to_bfloat16_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.uint32_to_bfloat16_ru(x)

    Convert a ``uint32`` to ``bfloat16`` with the selected rounding mode.

.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint32_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint32_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint32_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint32_ru(x)
...
.. function:: numba_cuda_mlir.cuda.bf16.int64_to_bfloat16_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.int64_to_bfloat16_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.int64_to_bfloat16_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.int64_to_bfloat16_ru(x)

    Convert an ``int64`` to ``bfloat16`` with the selected rounding mode.

.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int64_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int64_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int64_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int64_ru(x)
...
.. function:: numba_cuda_mlir.cuda.bf16.uint64_to_bfloat16_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.uint64_to_bfloat16_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.uint64_to_bfloat16_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.uint64_to_bfloat16_ru(x)

    Convert a ``uint64`` to ``bfloat16`` with the selected rounding mode.

.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint64_rn(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint64_rz(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint64_rd(x)
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint64_ru(x)
...
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_int8_rz(x)

    Convert a ``bfloat16`` to ``int8`` with round-towards-zero.

.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_to_uint8_rz(x)
...
.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_as_int16(x)

    Reinterpret the bits of ``bfloat16`` as an ``int16``.

.. function:: numba_cuda_mlir.cuda.bf16.bfloat16_as_uint16(x)

    Reinterpret the bits of ``bfloat16`` as a ``uint16``.

.. function:: numba_cuda_mlir.cuda.bf16.int16_as_bfloat16(x)

    Reinterpret the bits of an ``int16`` as a ``bfloat16``.

.. function:: numba_cuda_mlir.cuda.bf16.uint16_as_bfloat16(x)
