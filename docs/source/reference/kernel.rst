...
.. note:: The order of ``stream`` and ``sharedmem`` are reversed compared to in
   CUDA C++.

Dispatcher objects also provide several utility methods for inspection and
creating a specialized instance:

.. autoclass:: numba_cuda_mlir.descriptor.MLIRDispatcher
...
.. attribute:: numba_cuda_mlir.cuda.threadIdx
...
.. attribute:: numba_cuda_mlir.cuda.blockIdx
...
.. attribute:: numba_cuda_mlir.cuda.blockDim
...
.. attribute:: numba_cuda_mlir.cuda.gridDim

    The shape of the grid of blocks, accessed through the attributes ``x``,
    ``y``, and ``z``.

.. attribute:: numba_cuda_mlir.cuda.laneid
...
.. attribute:: numba_cuda_mlir.cuda.warpsize

    The size in threads of a warp on the GPU. Currently this is always 32.

.. function:: numba_cuda_mlir.cuda.grid(ndim)
...
.. function:: numba_cuda_mlir.cuda.gridsize(ndim)
...
.. function:: numba_cuda_mlir.cuda.shared.array(shape, dtype)
...
.. function:: numba_cuda_mlir.cuda.local.array(shape, dtype)
...
.. function:: numba_cuda_mlir.cuda.const.array_like(ary)
...
.. function:: numba_cuda_mlir.cuda.atomic.add(array, idx, value)
...
.. function:: numba_cuda_mlir.cuda.atomic.sub(array, idx, value)
...
.. function:: numba_cuda_mlir.cuda.atomic.and_(array, idx, value)
...
.. function:: numba_cuda_mlir.cuda.atomic.or_(array, idx, value)
...
.. function:: numba_cuda_mlir.cuda.atomic.xor(array, idx, value)
...
.. function:: numba_cuda_mlir.cuda.atomic.exch(array, idx, value)
...
.. function:: numba_cuda_mlir.cuda.atomic.inc(array, idx, value)
...
.. function:: numba_cuda_mlir.cuda.atomic.dec(array, idx, value)
...
.. function:: numba_cuda_mlir.cuda.atomic.max(array, idx, value)
...
.. function:: numba_cuda_mlir.cuda.atomic.cas(array, idx, old, value)
...
.. function:: numba_cuda_mlir.cuda.cg.this_grid()
...
.. class:: numba_cuda_mlir.cuda.cg.GridGroup
...
.. function:: numba_cuda_mlir.cuda.threadfence

   A memory fence at device level (within the GPU).

.. function:: numba_cuda_mlir.cuda.threadfence_block

   A memory fence at thread block level.

.. function:: numba_cuda_mlir.cuda.threadfence_system
...
.. function:: numba_cuda_mlir.cuda.syncwarp(membermask)

   Synchronize a masked subset of the threads in a warp.

.. function:: numba_cuda_mlir.cuda.all_sync(membermask, predicate)

    If the ``predicate`` is true for all threads in the masked warp, then
    a non-zero value is returned, otherwise 0 is returned.

.. function:: numba_cuda_mlir.cuda.any_sync(membermask, predicate)

    If the ``predicate`` is true for any thread in the masked warp, then
    a non-zero value is returned, otherwise 0 is returned.

.. function:: numba_cuda_mlir.cuda.eq_sync(membermask, predicate)
...
.. function:: numba_cuda_mlir.cuda.ballot_sync(membermask, predicate)

    Returns a mask of all threads in the warp whose ``predicate`` is true,
    and are within the given mask.

.. function:: numba_cuda_mlir.cuda.shfl_sync(membermask, value, src_lane)

    Shuffles ``value`` across the masked warp and returns the ``value``
    from ``src_lane``. If this is outside the warp, then the
    given ``value`` is returned.

.. function:: numba_cuda_mlir.cuda.shfl_up_sync(membermask, value, delta)

    Shuffles ``value`` across the masked warp and returns the ``value``
    from ``laneid - delta``. If this is outside the warp, then the
    given ``value`` is returned.

.. function:: numba_cuda_mlir.cuda.shfl_down_sync(membermask, value, delta)

    Shuffles ``value`` across the masked warp and returns the ``value``
    from ``laneid + delta``. If this is outside the warp, then the
    given ``value`` is returned.

.. function:: numba_cuda_mlir.cuda.shfl_xor_sync(membermask, value, lane_mask)

    Shuffles ``value`` across the masked warp and returns the ``value``
    from ``laneid ^ lane_mask``.

.. function:: numba_cuda_mlir.cuda.match_any_sync(membermask, value, lane_mask)

    Returns a mask of threads that have same ``value`` as the given ``value``
    from within the masked warp.

.. function:: numba_cuda_mlir.cuda.match_all_sync(membermask, value, lane_mask)
...
.. function:: numba_cuda_mlir.cuda.activemask()
...
.. function:: numba_cuda_mlir.cuda.lanemask_lt()
...
.. function:: numba_cuda_mlir.cuda.popc(x)

   Returns the number of bits set in ``x``.

.. function:: numba_cuda_mlir.cuda.brev(x)

   Returns the reverse of the bit pattern of ``x``. For example, ``0b10110110``
   becomes ``0b01101101``.

.. function:: numba_cuda_mlir.cuda.clz(x)

   Returns the number of leading zeros in ``x``.

.. function:: numba_cuda_mlir.cuda.ffs(x)
...
.. function:: numba_cuda_mlir.cuda.fma
...
.. function:: numba_cuda_mlir.cuda.cbrt (x)
...
.. function:: numba_cuda_mlir.cuda.is_float16_supported ()
...
.. function:: numba_cuda_mlir.cuda.fp16.hfma (a, b, c)
...
.. function:: numba_cuda_mlir.cuda.fp16.hadd (a, b)
...
.. function:: numba_cuda_mlir.cuda.fp16.hsub (a, b)
...
.. function:: numba_cuda_mlir.cuda.fp16.hmul (a, b)
...
.. function:: numba_cuda_mlir.cuda.fp16.hdiv (a, b)
...
.. function:: numba_cuda_mlir.cuda.fp16.hneg (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.habs (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.hsin (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.hcos (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.hlog (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.hlog10 (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.hlog2 (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.hexp (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.hceil (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.hsqrt (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.hrsqrt (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.hrcp (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.hrint (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.htrunc (a)
...
.. function:: numba_cuda_mlir.cuda.fp16.heq (a, b)

   Perform the comparison operation ``a == b`` on 16-bit floating point arguments.

   Returns a boolean.

.. function:: numba_cuda_mlir.cuda.fp16.hne (a, b)

   Perform the comparison operation ``a != b`` on 16-bit floating point arguments.

   Returns a boolean.

.. function:: numba_cuda_mlir.cuda.fp16.hgt (a, b)

   Perform the comparison operation ``a > b`` on 16-bit floating point arguments.

   Returns a boolean.

.. function:: numba_cuda_mlir.cuda.fp16.hge (a, b)

   Perform the comparison operation ``a >= b`` on 16-bit floating point arguments.

   Returns a boolean.

.. function:: numba_cuda_mlir.cuda.fp16.hlt (a, b)

   Perform the comparison operation ``a < b`` on 16-bit floating point arguments.

   Returns a boolean.

.. function:: numba_cuda_mlir.cuda.fp16.hle (a, b)

   Perform the comparison operation ``a <= b`` on 16-bit floating point arguments.

   Returns a boolean.

.. function:: numba_cuda_mlir.cuda.fp16.hmax (a, b)

   Perform the operation ``a if a > b else b.``

   Returns a 16-bit floating point value.

.. function:: numba_cuda_mlir.cuda.fp16.hmin (a, b)
...
using these intrinsics mean you don't have to rely on the optimizer identifying
and removing branches. For further documentation, including semantics, please
refer to the `relevant CUDA Toolkit documentation
<https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#comparison-and-selection-instructions>`_.


.. function:: numba_cuda_mlir.cuda.selp
...
.. function:: numba_cuda_mlir.cuda.nanosleep(ns)
